...
1. Read the project's `docs/` folder, in this order: `docs/00_VISION.md`, `docs/PROJECT.md`, `docs/SESSION_LOG.md`, `docs/03_DOMAIN_MODEL.md`, `docs/02_LANGUAGE.md`, `docs/01_ARCHITECTURE.md`, `docs/CONTRIBUTING_GUIDE.md` (binding project rules), and the accepted records under `docs/decisions/`. If `CLAUDE.md` or a root `README.md` exist, read those too.

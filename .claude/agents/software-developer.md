...
1. Read the project's `docs/` folder: `docs/PROJECT.md`, `docs/01_ARCHITECTURE.md`, `docs/03_DOMAIN_MODEL.md`, `docs/02_LANGUAGE.md`, `docs/00_VISION.md`, and — most importantly for you — every accepted record under `docs/decisions/` (ADRs). Also read `CLAUDE.md`/`README.md` if present.
